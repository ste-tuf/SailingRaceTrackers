...
with tab1:
    ...
    st.dataframe(
        stats_df[["boatName", "Class", "TWS", "TWD", "Dist 4h", "Dist 24h", "1h Speed", "1h VMG", "4h Speed", "4h VMG", "24h Speed", "24h VMG"]].style.format(format_dict, na_rep="-").background_gradient(
